...
dependencies {
    ...
    testImplementation "io.github.denisbronx.netmock:netmock-server:0.8.0"
    //mutliplatform and lighter weight option for ktor only library users
    testImplementation "io.github.denisbronx.netmock:netmock-engine:0.8.0"
    //library for accessing local json files in the test folder
    testImplementation "io.github.denisbronx.netmock:netmock-resources:0.8.0"
}
```
